...
correct_solution_sagan = dict([
    ...
    ("sagan.site.renderer.GuideMetadata[] SaganRendererClient.fetchGettingStartedGuides()", "non"),
    ...
    ("String GuideHeader.getZipUrl()", "sin"),  # not sure: no code
    ("String Tutorial.getGitUrl()", "sin"),     # not sure: no code
