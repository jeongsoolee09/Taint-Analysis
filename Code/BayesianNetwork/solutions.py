...
correct_solution_sagan = dict([
    ...
    ("void GettingStartedGuide.setImages(List)", "sin"),  # not sure: no code
    ...
    ("String GettingStartedGuide.getTableOfContents()", "src"),  # not sure: no code
    ...
    ("String GettingStartedGuide.getCloneUrl()", "src"),  # not sure: no code
    ("void MvcConfig.addInterceptors(InterceptorRegistry)", "non"),  # not sure: obscure
    ("String GuideHeader.getCloneUrl()", "src"),                     # not sure: obscure
    ("void Attributes.setAllowUriRead(boolean)", "sin"),             # not sure: no code
    ...
    ("GuideType GuideType.fromSlug(String)", "non"),  # not sure: no code
    ...
    ("void Feed.setTitle(String)", "sin"),  # not sure: no code
    ...
    ("void SpringApplication.configureProfiles(ConfigurableEnvironment,java.lang.String[])", "non"),  # not sure: no code
    ("byte[] GithubClient.downloadRepositoryAsZipball(String,String)", "src"),  # not sure: no code
    ...
    ("Optional GettingStartedGuides.findByName(String)", "src"),  # not sure: no code
    ("ResultMatcher StatusResultMatchers.isOk()", "san"),
    ("String GettingStartedGuide.getRepositoryName()", "src"),  # not sure: no code
    ("String Topical.getTitle()", "src"),                       # not sure: no code
    ("String BlogAdminController.showPost(Long,String,Model)", "sin"),
    ("Period Period.of(String,int)", "non"),  # not sure: no code
    ...
    ("String Tutorial.getCiLatestUrl()", "src"),  # not sure: no code
    ("boolean File.exists()", "src"),
    ("String Tutorial.getCloneUrl()", "src"),  # not sure: no code
    ...
    ("Object ProjectMetadataRepository.findOne(Serializable)", "src"),  # not sure: no code
    ...
    ("String GuideHeader.getRepositoryName()", "src"),  # not sure: no code
    ...
    ("String GettingStartedGuide.getSshUrl()", "src"),  # not sure: no code
