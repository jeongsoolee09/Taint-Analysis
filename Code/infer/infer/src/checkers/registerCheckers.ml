...
let all_checkers =
  ...
  ; { name= "My Liveness checker"
    ; active= Config.my_liveness_checker
    ; callbacks= [ (Procedure MyLivenessChecker.checker, Language.Clang)
                 ; (Procedure MyLivenessChecker.checker, Language.Java)] }
